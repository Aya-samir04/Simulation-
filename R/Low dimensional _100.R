...
colnames(fixedMSE_results)=c("LMM","REEM tree","MERF","QLMM","QRF",
                         "Xgboostquantile")
write.csv(MSE_results,"scenario1rf_100_6_MSE_results.csv")
write.csv(fixedMSE_results,"scenario1rf_100_6_fixedMSE_results.csv")
write.csv(MAE_results,"scenario1rf_100_6_MAE_results.csv")
