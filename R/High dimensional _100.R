...
write.csv(MSE_results,"scenario1_h100_6_MSE_results.csv")
write.csv(fixedMSE_results,"scenario1_h100_6_fixedMSE_results.csv")
write.csv(MAE_results,"scenario1_h100_6_MAE_results.csv")
